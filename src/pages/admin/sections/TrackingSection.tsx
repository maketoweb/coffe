...
import { MapPin, Clock, CheckCircle, Truck, ArrowRight, Package, Navigation } from 'lucide-react';
...
const TrackingSection: React.FC<TrackingSectionProps> = ({ scopeSedeId }) => {
  const { config } = useApp();
  ...
  const { activeOrders, advanceStatus, advancingId } = useOrders(lockedSede || sedeFilter || undefined);
